This is my 1st Car price predection model with 2060 instance (rows) and  16 features (column) and my agenda is predecting car_price using 
regression model

What i did in  this model 1st i use feature Engineering and also use feature extraction for reducing the course of dimensionality by applying PCA
